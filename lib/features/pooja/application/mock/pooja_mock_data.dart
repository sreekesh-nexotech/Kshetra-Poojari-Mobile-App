...
abstract final class PoojaMockData {
  ...
  static const List<_Group> _groups = [
    // ── ശ്രീ ഗണപതി (g1) ───────────────────────────────────────────────────
    _Group('g1', 'ഗണപതി ഹോമം', incentive: true, people: [
    ...
    _Group('g1', 'പഞ്ചാമൃത ഹോമം', special: true, incentive: true, people: [
      _P('Harichandran', 'പൂരം', 'ജോലിക്ക്'),
      _P('Devika', 'പൂരം', 'പരീക്ഷയ്ക്ക്'),
    ]),
    _Group('g1', 'ഭാഗ്യസൂക്ത അർച്ചന', people: [
      _P('Latha', 'അത്തം'),
      _P('Rajesh', 'മൂലം', 'പുതിയ സംരംഭം'),
      _P('Meera', 'രേവതി'),
      _P('Ajith', 'ഭരണി'),
    ]),
    _Group('g1', 'സഹസ്രനാമ അർച്ചന', incentive: true, people: [
      _P('Geetha', 'തിരുവോണം'),
      _P('Mohan', 'അവിട്ടം', 'രോഗശാന്തിക്ക്'),
      _P('Shalini', 'ചോതി'),
    ]),
    _Group('g1', 'മോദക നിവേദ്യം', reassigned: true, people: [
      _P('Nandu', 'പുണർതം'),
      _P('Sreeja', 'ആയില്യം'),
    ]),
    _Group('g1', 'അപ്പം നിവേദ്യം', doneAt: '07:40 AM', people: [
      _P('Babu', 'മകയിരം'),
      _P('Reshmi', 'വിശാഖം'),
      _P('Krishnan', 'ഉത്രം'),
    ]),
    // ── ശ്രീ ഭഗവതി (g2) ───────────────────────────────────────────────────
    _Group('g2', 'ഭഗവതി സേവ', special: true, incentive: true, people: [
      _P('Lakshmi Menon', 'അശ്വതി', 'വിവാഹത്തിന്'),
      _P('Anil Kumar', 'ഭരണി'),
    ]),
    _Group('g2', 'കുങ്കുമാർച്ചന', people: [
      _P('Sindhu', 'കാർത്തിക'),
      _P('Radhika', 'തൃക്കേട്ട', 'പരീക്ഷയ്ക്ക്'),
      _P('Unni', 'ചതയം'),
    ]),
    _Group('g2', 'കുങ്കുമാർച്ചന', reassigned: true, people: [
      _P('Vinod', 'ഉത്രാടം'),
      _P('Maya', 'പൂരാടം'),
    ]),
    _Group('g2', 'രക്തപുഷ്പാഞ്ജലി', people: [
      _P('Deepa', 'ചിത്തിര', 'ജന്മദിനം'),
      _P('Shaji', 'അനിഴം'),
      _P('Ramya', 'മകം'),
    ]),
    _Group('g2', 'നെയ് വിളക്ക്', people: [
      _P('Satheesan', 'പൂയം'),
      _P('Ammu', 'രോഹിണി'),
      _P('Jayan', 'മൂലം'),
      _P('Nimmi', 'അത്തം'),
    ]),
    _Group('g2', 'ത്രികാല പൂജ', doneAt: '06:30 AM', people: [
      _P('Suresh', 'തിരുവാതിര'),
      _P('Kamala', 'ഉത്രട്ടാതി'),
    ]),
  ];
}
